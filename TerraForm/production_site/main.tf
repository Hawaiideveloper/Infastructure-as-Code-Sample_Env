...
resource "aws_vpc" "production" {
  ...
  tags = {
    "Name" = "Corey"
    "Email" = "hawaiideveloper@gmail.com"
    "Phone" = "202-642-67**"
  }
}
...
resource "aws_route_table_association" "production" {
    subnet_id = aws_subnet.production_subnet0
    route_table_id = aws_route_table.for_production_only.id 
}
...
resource "aws_instance" "webserver" {
    ...
    availability_zone = "us-west-2b"
     ...
     subnet_id = aws_subnet.production_subnet0.id
}
